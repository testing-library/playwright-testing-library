...
import queriesFixture from '../lib/fixture'
import {IScopedQueryUtils} from '../lib/typedefs'
...
test.describe('lib/fixture.ts', () => {
  ...
  test('should handle the query* methods', async ({queries}) => {
  ...
  test('should handle the get* methods', async ({queries, page}) => {
